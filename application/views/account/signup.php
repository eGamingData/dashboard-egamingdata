...
<div class="login-box">
  ...
  <div class="login-logo">
    ...
    <p class="login-box-msg">Sign up to create new member </p>
  ...
  <p><?php echo $this->session->flashdata('msg') ?></p>
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
             <div class="form-group has-feedback">
        <input style="border-radius: 1.5rem;" type="number" class="form-control" placeholder="Phone"  value="<?php echo post('phone') ?>" name="phone" autofocus />
     ...
     <div class="row">
        ...
        <?php echo form_error('cpassword', '<div class="error" style="color: red;">', '</div>'); ?>
      </div>
        </div>
    </div>
