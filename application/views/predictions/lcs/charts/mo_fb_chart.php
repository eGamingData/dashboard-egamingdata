...
try{
    ...
    $handle = $link->prepare('SELECT team_one,result_team_one, result_tie, team_two, result_team_two, tie_label, data_event FROM lol_models WHERE mo_type="mo_fb"  AND league="lcs" '); 
    $handle->execute(); 
